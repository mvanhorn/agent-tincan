...
Download manually from $REPO_URL/releases"
	...
	*)
	...
	say ""
	say "Next steps:"
	say "  Run a relay on your always-on machine:"
	say "    TS_AUTHKEY=tskey-auth-... tincan relay --admin my-laptop"
	say "  Or join a relay as an agent, with the code from tincan invite:"
